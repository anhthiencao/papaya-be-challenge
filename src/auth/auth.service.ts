...
import type { JwtPayload, JwtPublisherPayload, JwtSign, Payload, jwtSignPublisher } from './auth.interface';
...
export class AuthService {
  ...
  public jwtSignPublisher(data: JwtPublisherPayload): jwtSignPublisher {
